...
static unsigned long timerDelay = 20 * 1000; // Send data every 20 seconds
...
void loop() {
  if ((millis() - lastTime) > timerDelay) {
    float temperature = 40; //dht.readTemperature(); // Read temperature in Celsius
